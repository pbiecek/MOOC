...
Ich liczba będzie wymieniona w wyniku funkcji summary(). Dla zmiennej _Przebieg.w.km_ brakujących wartości jest 20 711.
...
Aby to zrobić w programie R, do funkcji należy dodać argument _na.rm=TRUE_, gdzie _na.rm_ to skrót od _remove NA_, czyli usuń wartości brakujące.
...
### Odpowiedzi:
+ Dla zmiennej Przebieg.w.km  jest 20 711 brakujących wartości. Ta zmienna jest najmniej kompletna.
+ 115 cm3
