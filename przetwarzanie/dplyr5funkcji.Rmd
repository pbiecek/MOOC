...
Rozwiązaniem tego problemu jest stosowanie specjalnego operatora do przetwarzania potokowaegp `%>%`. Ten operator pochodzi z pakietu `magritr` i jest dostępny po włączeniu pakietu `dplyr`.
...
Ta prosta sztuczna pozwala znacząco skrócić zapis i uczynić go znacznie czytelniejszym.
