...
date: "sezon 2 / odcinek 15 <br><br> Zbyszek Marczewski, Jakub Rutkowski, Przemek Kopa <br/> Na straży sondaży<br><br>Naciśnij `A` by zamienić slajdy na ciągły tekst. <br> Naciśnij `T` by wyświetlić spis treści."
output:
  slidy_presentation:
    includes:
...
Ten odcinek jest też dostępny w formacie video na kanale youtube
https://youtu.be/HeuEStD4noU
