...
=======
# uzywanie ujemnych indeksow by pominac wiersze
>>>>>>> s1e7eng
koty_ptaki[ -c(1, 3, 8:10), ]
```
...
=======
- Select all the rows except "Sokoły" (falcons: "Sokol wedrowny" and "Sokol norweski", rows 11 and 12) from the data frame `koty_ptaki`.
>>>>>>> s1e7eng
