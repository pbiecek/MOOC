...
Na czasach można wykonywać takie operacje jak odejmowanie czy dodawane do jednego czasu określonego przedziału (domyślnie dni).
...
W podstawowy programie R operacja na datach i czasie nie zawsze są proste. Tzn proste operacje są proste, ale złożone już niekoniecznie.
