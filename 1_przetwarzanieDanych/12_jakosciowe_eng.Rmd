...
date: season 1 / episode 12<br><br><br><br>Press `A` to change slides into text <br> Press `T` to display table of contents.
output:
  beamer_presentation:
    highlight: default
  slidy_presentation:
    css: ../style.css
    font_adjustment: 0
    footer: Data CruncheRs / processing / qualitative variables
    highlight: default
    includes:
