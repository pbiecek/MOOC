...
Można taką operację sklejania łatwo wykonać funkcją `unite()`.
...
W przykłądzie poniżej w zbiorze danych `tsdtr210` tworzymy nową kolumnę o nazwie `panstwo_rok`, któ®ej wartości powstaną przez połaczenie wartości w kolumnach `geo` i `time` rozdzielając je znakiem `:`.
