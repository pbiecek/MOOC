...
```{r, eval=FALSE}
library(xlsx)
write.xlsx(dwie_kolumny, file="/Users/pbiecek/Documents/wazne_dane.csv", 
...
Odczytując dane funkcją `load()`, do programu R wczytywane są obiekty razem z nazwami (pisaliśmy o tym w poprzednim odcinku). Dlatego możemy do jednego pliku zapisać kilka obiektów i po wczytaniu danych nie będzie kolizji nazw.
