...
*Uwaga!* Pakiet `SmarterPoland` nie jest dostępny w podstawowej dystrybucji programu R i trzeba go wcześniej zainstalować poleceniem `install.packages()`. Szczegółowa instrukajc, jak to zrobić jest przedstawiona w odcinku 2 *Jak zainstalować R, RStudio oraz dodatkowe pakiety?*.
