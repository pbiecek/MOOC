...
W jaki sposób dane tabelaryczne sapisane są w tym pliku?
...
Aby na nim pracować, musimy wynik funkcji `read_table()` zapamiętać w zmiennej. Na przykład w zmiennej o nazwie `duze_koty`.
...
![Zbiór danych o kotach](koty.png)
...
Rozważając różne opcje, stwierdziłem że najłatwiejsza to z odpostępnienie danych z użyciem pakietu dla programu R.
...
![Lista dostępnych zbiorów danych](datasets_list.png)
---
