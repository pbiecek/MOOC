...
date: "sezon 1 / odcinek 27 <br><br> <a href='http://biecek.pl/R'>Przemysław Biecek @ Uniwersytet Warszawski</a><br><br><br>Naciśnij `A` by zamienić slajdy na ciągły tekst. <br> Naciśnij `T` by wyświetlić spis treści."
output:
  slidy_presentation:
    includes:
...
Rozwiązanie dowolnych 15 zadań jest wymagane do zaliczenia kursu. 
...
<a href="http://biecek.pl/R"><img align="right" style="border: solid 1px" width="300px" src="http://biecek.pl/grafika/okladkaPrzewodnikR.png"></a>
