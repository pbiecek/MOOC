...
*Uwaga* O ile polecenie `install.packages()` instaluje na komputerze odpowiedni pakiet. Przed jego użyciem za każdym razem powinniśmy pakiet włączyć poleceniem `library()`.
