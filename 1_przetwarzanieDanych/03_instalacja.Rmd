...
date: "sezon 1 / odcinek 3 <br><br>Przemysław Biecek @ Uniwersytet Warszawski<br><br>Naciśnij `A` by zamienić slajdy na ciągły tekst. <br> Naciśnij `T` by wyświetlić spis treści."
output:
  slidy_presentation:
    includes:
