...
przekształcić (np. data, którą można przekształcić na napus by wyłuskać rok i miesiąc).
...
jest zwielokrotniny tylekrotnie, aby dorównał długością dłuższemu (tzw. recycling rule). Z tego powodu trzeci argument - pojedyncza 
