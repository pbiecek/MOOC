...
W procesie przygotowania danych takie filtrowanie jest niesamowicie częstą instrukcją. W odcinku 7 pokazaliśmy jak wybierać wiersze spełniające określone kryterium, używając operatora `[`. W codziennej pracy, i wygodniej, i szybciej jest wykorzystać dedykowaną funkcję `filter()` z pakietu `dplyr`.
