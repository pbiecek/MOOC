...
date: "sezon 1 / odcinek 3 <br><br> Wszelkie prawa zastrzeżone.<br> Wykorzystanie możliwe wyłącznie za zgodą autora. <br><br><br><br>Naciśnij `A` by zamienić slajdy na ciągły tekst. <br> Naciśnij `T` by wyświetlić spis treści."
output:
  slidy_presentation:
    includes:
...
Pracując ze slajdami, możemy w każdej chwili nacisnąć przycisk `T`, rozwinie on spis treści, dzięki czemu łatwo nam będzie przejść do pożądanego slajdu.
...
Pierwsze zadania są proste, kolejne coraz trudniejsze. Warto zmierzyć się z nimi, jedynym sposobem by nauczyć się języka programowani jest ćwiczenie, ćwiczenie i jeszcze raz ćwiczenie.
