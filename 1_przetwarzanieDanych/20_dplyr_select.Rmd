...
Pracując na danych o ofertach sprzedaży aut można było odczuć jak niewygodna jest praca na danych które mają wiele kolumn, w sytuacji gdy potrzebujemy jedynie kilku z nich. W odcinku 7 pokazaliśmy jak wybierać kolumny spełniające określone kryterium, używając operatora `[`. 
...
Jeżeli kolumn w zbiorze danych jest wiele to wymienienie ich nazw jedna po drugiej może być niewygodne. W tym przypadku wato wykorzystać operator `:`, który pozwala na wybór kolumn od wskazanej do wskazanej.
...
Przykład poniżej wykorzystujemy funkcję `martches()` aby wybrać wszystkie nazwy kolumn, które w nazwie mają wzorzec `aj`.
