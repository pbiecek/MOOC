...
Pliki csv są również poprawnie odczytywane przez program Excel, przez co jest to popularne medium wymiany danych tabelarycznych. Poniższa instrukcja tworzy nowe dane o nazwie `dwie_kolumny` oraz zapisuje je do pliku `wazne_dane.csv` stosując jako separator kolumn średnik a jako kropkę dziesiętną znak `.`.
