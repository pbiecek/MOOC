...
funkcja `which()` [PCH: sugeruję dodać poradę dotyczącą wymowy, tzn. "z ang. wym.: hłicz"] wyznacza indeksy wartości brakujących. Te indeksy będą następnie wykorzystane aby nadpisać wartości brakujące przez średnią wyznaczoną przez funkcję `mean()`.
