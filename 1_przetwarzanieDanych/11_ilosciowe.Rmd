...
Dlatego, dalsze ćwiczenia ze zmiennymi ilościowymi przeprowadzimy na znaczeni większym zbiorze danych z ponad 200 tysiącami wartości, o nazwie `auta2012`, który znajduje się również w pakiecie `PogromcyDanych`.
...
Niezbyt jasne, więc możę na przykładzie.

```{r, warning=FALSE}
quantile(auta2012$Cena.w.PLN, c(0.01, 0.1, 0.25, 0.5, 0.75, 0.90, 0.99))
```

Kwantyl rzędu `1%` to 1500, czyli co setna oferta jest tańśza niż 1500 PLN. Kwantyle rzędu `10%` to 5500, czyli jedna dziesiąta ofert jest tańsza niż 5.5 tys. Kwantyl rzędu `90%` to 72.5 tys, czyli co dziesiąty samochód jest droższy niż 72 500 pln.
