...
- Jakie zmienne / wartości / cechy określa się terminem cechy ilościowe?
...
W poprzednim odcinku poznaliśmy kilka sposobów na wczytanie danych do R. 

Dane na których będziemy tutaj pracować, zostały włączone do pakietu `SmarterPoland` by ułatwić dostęp do nich. Aby je wczytać, wystarczy włączyć pakiet.
...
Przyjrzyjmy się takim cechom jak _Cena.w.PLN_ lub _Przebieg.w.km_. 

Cechy te są opisane przez liczby oraz przedstawiają ilości. 
