...
[PCH: Warto zwrócić uwagę na wynik (TRUE | NA) oraz (FALSE & NA). Oraz na to, że && różni się od & !]

---

# Wczytanie danych

Dane od których rozpoczniemy przykłady to `koty_ptaki` z pakietu `SmarterPoland`. 
...
ponad 200 tysiącami wartości, który również znajduje się w pakiecie `SmarterPoland`.
