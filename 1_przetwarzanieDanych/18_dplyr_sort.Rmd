...
O ile wektor wartości można posortować funkcją `sort()`, to do sortowania wierszy w ramce danych względem określonej kolumny wygodnie jest użyć funkcję `arrange()`.
