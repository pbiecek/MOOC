...
date: "Season 1 / Episode 14<br><br><br><br>Press `A` to see the plain text instead of the slides. <br> Press `T` to display the table of contents."
output:
  slidy_presentation:
    includes:
    ...
    css: ../style.css
    font_adjustment: 0
    footer: "Data CruncheRs / processing / character variables"
