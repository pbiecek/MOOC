...
date: "season 1 / episode 6<br><br><br><br>Press `A` to switch from slides to continuous text. <br> Press `T` to see the table of contents."
output:
  slidy_presentation:
    includes:
    ...
    css: ../style.css
    font_adjustment: 0
    footer: "Data CruncheRs / data exploration / saving data in R"
---
