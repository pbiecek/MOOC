...
Funkcja `mean()` wyznacza średnią, funkcja `var()` wyznacza wariancję a pierwiastek z wariancji jest odchyleniem standardowym, funkcja `median()` wyznacza liczbę obserwacji w grupie.
