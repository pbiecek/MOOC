...
date: "season 0 / episode 0<br><br> All rights reserved.<br> Any use requires author’s consent.  <br><br><br><br>Press `A` to convert slides into a continuous text. <br> Press `T` to display table of contents."
output:
  slidy_presentation:
    includes:
    ...
    css: ../style.css
    font_adjustment: 0
    footer: "Data CruncheRs / eksploracja danych / zadania i odpowiedzi"
---
...
# median care age is 2012 - median year of production
