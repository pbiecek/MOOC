...
+ Przedstaw graficznie za pomocą wykresu pudełko-wąsy oraz histogramu rozkład cechy `Cena.w.PLN`. PCH: brak odpowiedzi poniżej. To celowe?
...
+ Aut w jakiej cenie jest najwięcej wśród zebranych ogłoszeń? PCH: brak odpowiedzi poniżej. To celowe?
