...
date: "sezon 1 / odcinek 25 <br><br><br><br>Naciśnij `A` by zamienić slajdy na ciągły tekst <br> Naciśnij `T` by wyświetlić spis treści"
output:
  slidy_presentation:
    includes:
...
Aby nie kopiować dwukrotnie danych dla obu wersji językowych po wczytaniu pakietu `PogromcyDanych` dostępne są dane w języku polskim.
...
imiona_warszawa   | warsaw_names       | Imiona noworodków w Warszawie
