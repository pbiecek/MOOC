...
Dane są dostępne w pakiecie `PogromcyDanych`, a funkcje do operacji na danych w pakiecie `dplyr`. Funkcją `filter()` wybieramy interesujące nas wiersze, a funkcją `select()` interesujące nas kolumny.
