...
Przetwarzanie danych wykonuje się po to by przygotować się do analizy. Analizę danych przeprowadza się po to  by te dane zrozumieć. Zrozumiawszy dane, zależności pomiędzy zmiennymi i charakterystyki zmiennych, można istotne cechy danych pokazać.
