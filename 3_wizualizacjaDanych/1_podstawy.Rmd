...
Aby odtworzyć przykłady z tego odcinka potrzebny jest pakiet `PogromcyDanych`. Informacja o tym jak go zainstalować jest umieszczona w odcinku drugim *Jak zainstalować R, RStudio oraz dodatkowe pakiety?*.
...
To, w jaki sposób tworzą one wykres wyjaśnimy na kolejnym slajdzie o tytule *Elementy wykresu punktowego*, w tym miejscu, przyjrzyjmy się wyłącznie wynikom, które obie instrukcje produkują.
...
Dla pewnego zbioru obiektów mamy dwie zmienne ilościowe (np. dla państw to może być PKB i średnia długość życia, dla osób to może być wzrost i waga, dla samochodów to może być przebieg i cena).
...
Na wykresie punktowym można również zaznaczyć grupy, pozwala to dodatkowo na porównanie grup pod względem przedstawianych zmiennych. Taki wykres punktowy z grupami warto stosować gdy
