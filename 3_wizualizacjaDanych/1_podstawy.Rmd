...
Wykres punktowy stosuje się najczęściej w sytuacji gdy dla pewnego zbioru obiektów mamy dwie zmienne ilościowe (np. dla państw to może być PKB i średnia długość życia, dla osób to może być wzrost i waga, dla samochodów to może być przebieg i cena).
