...
Na wykresie punktowym można również zaznaczać grupy wierszy. Oznaczając je kolorem, kształtem lub wielkością. Pozwala to dodatkowo na porównanie grup pod względem przedstawianych zmiennych (patrz rysunek poniżej). Taki wykres punktowy z grupami warto stosować gdy:
...
<img width=800 src="grupowanie.png"/>
