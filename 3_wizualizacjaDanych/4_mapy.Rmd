...
Mapy można rysować w różnych projekcjach. Aby je wybrać wystarczy dodać wywołanie funkcji `coord_map()`. Poniżej dwa przykładowe projekcie. Listę projekcji z opisem właściwości znaleźć można pod adresem http://en.wikipedia.org/wiki/List_of_map_projections
