...
Będziemy testować hipotezę (=przypuszczenie), czy współczynnik wzrostu jest istotnie różny od zera, czyli od braku trendu. 
...
Przeprowadźmy te same obliczenia, a wyniki porównamy w ten sam sposób co poprzednio.
...
W przypadku serialu *Friends* próbowaliśmy tego samego. Z tą różnicą, że udawało się dosyć często w wyniku losowych permutacji uzyskać wartości większe, niż dla oryginalnej kolejności. 

Statystykę, opisującą jaka część losowo wygenerowanych trendów jest większa, niż zaobserwowany trend, nazywamy p-wartością. Przyjęliśmy też, że jeżeli p-wartość będzie mała, np. mniejsza niż 0.05 (arbitralny wybór, ale się przyjęło) to uznamy, że trend jest istotny. 
