...
toDownload <- data.frame(c("tt2193021","tt1871731"),
                         c("Arrow","Ninjago: Masters of Spinjitzu"))

serialeIMDB2 <- do.call(rbind, res)
serialeIMDB <- rbind(serialeIMDB, serialeIMDB3)

Encoding(levels(serialeIMDB$nazwa))
save(serialeIMDB, file="serialeIMDB.rda", compress = "xz", compression_level = 9)

toDownload <- data.frame(c("tt0086791","tt1442462"),
                         c("Robin of Sherwood","The Good Wife"))
