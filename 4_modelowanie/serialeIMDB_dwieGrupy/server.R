...
shinyServer(function(input, output) {
  mySerial <- reactive({
    serialeIMDB[serialeIMDB$serial == input$serial1, ]
  })
  ...
  output$opis = renderUI({
    ...
    HTML("Dane o ocenach serialu <b>",as.character(ser$serial1[1]),"</b> można pobrać ze strony <br/> <a href='", napis, "'>",napis,"</a><br><br>",
