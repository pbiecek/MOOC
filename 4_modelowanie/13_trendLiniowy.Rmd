...
export_png(pp,"_wykres001.png") 
```
<center><img src="_wykres001.png"></center>
...
export_png(pp,"_wykres002.png") 
```
<center><img src="_wykres002.png"></center>
...
pp <- serialeIMDB %>%
  ...
  mutate(sezon = droplevels(sezon)) %>%
    ...
    layer_points(fillOpacity:=0.8) %>%
    layer_smooths() 
export_png(pp,"_wykres003.png") 
```
<center><img src="_wykres003.png"></center>
