...
Zbudować taki model multiplikatywny z użyciem funkcji `lm()` należy wpierw musimy policzyć logarytm ceny.
...
Przyglądając się dokładniej, okazuje się, że są wśród naszych ofert auta o absurdalnym przebiegu ponad 15 milionów kilometrów. To ewidentny błąd. 
...
Czy volkswagenami starszymi niż 5 lat mniej się jeździ? Jest to jakieś wytłumaczenie, ale inne, bardziej prawdopodobne, jest takie że starsze auta rzadziej są serwisowane, a przez to ich przebiegi często są wartościami deklarowanymi.
