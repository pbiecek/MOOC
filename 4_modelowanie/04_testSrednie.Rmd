...
To liczenie różnic na próbach różniących się jedynie losową fluktuacją jest realizowane przez ponższy kod.
...
Różnica średnich pomiędzy tymi dwoma serialami wynosi 0.48. Wygląda na dużo, ale czy amy jakiś argument, że jest to więcej niż przypadkowa fluktuacja?
...
Powtórzmy test permutacyjny dla tych dwóch seriali. Tym razem obserwowana różnica jest wyższa niż praktycznie wszystkie wartości wygenerowane rpzez test permutacyjny.
