...
Tabelę liczebności dla 200 rozkłądów trudo się przegląda. Jeżeli interesują nas najczęstsze lub najrzadsze wartości to aby je odczytać warto tabelę liczebności posortować.
...
Z pewnoscią interesującą informajcą jest to jak dany serial oceniano.
...
Często interesujące są obserwacje skrajne. Jak najłatwiej się zorientować które odcinki uzyskują skrane oceny?

Najłatwiej posotrtować odcinki po ocenie i wyświetlić taki posortowany zbiór danych.
...
Dla serialy Breaking Bad mamy dostępną informację o 62 odcinakch, ale czasem chcielibyśmy myśleć o nich jak o pewnej całości. Czy cały serial jest dobry czy nie?
...
Co możmy odczytać z takiej reprezentacji danych? Naprawdę wiele rzeczy, znajdźmy trzy ciekawe obserwacje.
...
Najsłabsze wyniki notuje sezon 3. W nim to znajduje się odcinej najgożej oceniany. Też dla niego mediana jest najniżej.

Największą zmienność obserwuje się dla sezonu 4. Byłw nim i bardzo słaby odcinek (jak na ten serial) i bardzo dobry odcinek.
...
- Zamiast prezentować informację o ocenie odcinka przedstaw informację o liczbie oddanych głosów (popularności) odcinka. Czy te same statystyki nadają się równie dbrze do prezentacji informacji o ocenie i o liczbie głosów?
